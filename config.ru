...
map '/' do
welcome = proc do |env|
[200, { "Content-Type" => "text/html" }, [<<WELCOME_CONTENTS <!doctype html>
  <html lang="en">
 ...
 */
  ...
  <body>
    ...
    <section class='container'>
      <hgroup>
        <h1>안녕하세요. 안전하고 편리한 KOMERI CLOUD PLATFORM 입니다.</h1>
      </hgroup>
      ...
      <div class="row">
        <section class='col-xs-12 col-sm-6 col-md-6'>
          ...
          <p>Documentation on how to manage your application from the Web Console or Command Line is available at the <a
              href="http://docs.okd.io/latest/dev_guide/overview.html">Developer Guide</a>.</p>

          <h3>Web Console</h3>
          <p>You can use the Web Console to view the state of your application components and launch new builds.</p>

          <h3>Command Line</h3>
          <p>With the <a href="http://docs.okd.io/latest/cli_reference/overview.html">OpenShift command line
              interface</a> (CLI), you can create applications and manage projects from a terminal.</p>
        ...
        <section class="col-xs-12 col-sm-6 col-md-6">
          ...
          <ul>
            ...
            <li><a href="http://docs.okd.io/latest/using_images/s2i_images/ruby.html">Getting Started with Ruby on
                OpenShift</a></li>
            <li><a href="http://stackoverflow.com/questions/tagged/openshift">Stack Overflow questions for OpenShift</a>
            </li>
